	...
	function loadData(field, word) {
		$.getJSON("list", {
			...
			$.each(resp.arr, function(key, val) {
				str += val.num + "  "
				str += "<a href='javascript:fview(" + val.num + ")'>"
						+ val.name + "</a>   "
				str += val.content + "  "
				str += val.grade + "  "
...
<body>
	<form action="insert" method="post">
		<table>
			...
			<tr>
				<td>평가</td>
				<td><input type="radio" name="grade" value="excellent" checked>아주잘함(excellent)
					<input type="radio" name="grade" value="good"> 잘함(good) <input
					type="radio" name="grade" value="normal"> 보통(normal) <input
					type="radio" name="grade" value="fail"> 노력(fail)</td>
			</tr>
			<tr>
				<td colspan="2"><input type="button" value="입력" id="send">
				</td>
			</tr>
		</table>
		<div align="right">
			<select name="field" id="field">
				...
				type="button" value="찾기" id="btnSearch">
		</div>
	</form>
	<hr />
	<div id="cnt"></div>
